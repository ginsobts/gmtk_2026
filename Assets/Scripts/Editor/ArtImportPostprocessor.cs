...
/// 作用范围：Resources/Art/Characters、Portraits、Imposters、Camera、town_ground_texture。
...
public class ArtImportPostprocessor : AssetPostprocessor
{
    void OnPreprocessTexture()
    {
        ...
        if (p.EndsWith("/town_ground_texture.png"))
        {
            ConfigureGroundTexture((TextureImporter)assetImporter);
            return;
        }

        bool isCharacterLike =
            p.Contains("/Resources/Art/Characters/") ||
            p.Contains("/Resources/Art/Portraits/") ||
        ...
        bool isPortraitUi = p.Contains("/Resources/Art/Portraits/");
        settings.spriteAlignment = isPortraitUi
    ...
    static void ConfigureGroundTexture(TextureImporter ti)
    {
